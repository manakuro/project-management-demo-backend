...
func ProjectTask(ctx context.Context, client *ent.Client) {
	...
	marketingID := feedutil.GetProjectByName(ctx, client, projectFeed.marketing.name).ID
	ts := []ent.CreateProjectTaskInput{
		// App Development
		{
			...
			ProjectTaskSectionID: feedutil.GetProjectTaskSectionByName(ctx, client, appDevelopmentID, projectTaskSectionFeedAppDevelopment.backlog.Name).ID,
		},
		{
			ProjectID:            appDevelopmentID,
		...
		},
		{
			...
			ProjectTaskSectionID: feedutil.GetProjectTaskSectionByName(ctx, client, appDevelopmentID, projectTaskSectionFeedAppDevelopment.ready.Name).ID,
		},
		{
			ProjectID:            appDevelopmentID,
		...
		},
		{
			...
			ProjectTaskSectionID: feedutil.GetProjectTaskSectionByName(ctx, client, appDevelopmentID, projectTaskSectionFeedAppDevelopment.inProgress.Name).ID,
		},
		{
			ProjectID:            appDevelopmentID,
		...
		},
		{
			...
			ProjectTaskSectionID: feedutil.GetProjectTaskSectionByName(ctx, client, appDevelopmentID, projectTaskSectionFeedAppDevelopment.done.Name).ID,
		},
		{
			ProjectID:            appDevelopmentID,
		...
		// Marketing - Planning
		{
			...
			ProjectTaskSectionID: feedutil.GetProjectTaskSectionByName(ctx, client, marketingID, projectTaskSectionFeedMarketing.planning.Name).ID,
		},
		{
			ProjectID:            marketingID,
		...
		// Marketing - Upcoming
		{
			...
			ProjectTaskSectionID: feedutil.GetProjectTaskSectionByName(ctx, client, marketingID, projectTaskSectionFeedMarketing.upcoming.Name).ID,
		},
		{
			ProjectID:            marketingID,
		...
		// Marketing - Content Development
		{
			...
			ProjectTaskSectionID: feedutil.GetProjectTaskSectionByName(ctx, client, marketingID, projectTaskSectionFeedMarketing.contentDevelopment.Name).ID,
		},
		{
			ProjectID:            marketingID,
		...
		// Marketing - Campaign Promotion
		{
			...
			ProjectTaskSectionID: feedutil.GetProjectTaskSectionByName(ctx, client, marketingID, projectTaskSectionFeedMarketing.campaign.Name).ID,
		},
		{
			ProjectID:            marketingID,
