...
type TestUser interface {
	...
	ListWithPagination(ctx context.Context, after *model.Cursor, first *int, before *model.Cursor, last *int, where *model.TestUserWhereInput, preloads []string) (*model.TestUserConnection, error)
...
func (t *testUser) ListWithPagination(ctx context.Context, after *model.Cursor, first *int, before *model.Cursor, last *int, where *model.TestUserWhereInput, preloads []string) (*model.TestUserConnection, error) {
	return t.testUserRepository.ListWithPagination(ctx, after, first, before, last, where, preloads)
}
