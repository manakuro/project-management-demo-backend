...
func (c *teammateTaskListStatusController) ListWithPagination(ctx context.Context, after *model.Cursor, first *int, before *model.Cursor, last *int, where *model.TeammateTaskListStatusWhereInput, requestedFields []string) (*model.TeammateTaskListStatusConnection, error) {
	return c.teammateTaskListStatusUsecase.ListWithPagination(ctx, after, first, before, last, where, requestedFields)
}
