...
// Returns a *NotSingularError when exactly one TeammateTaskSection entity is not found.
...
// Returns a *NotSingularError when exactly one TeammateTaskSection ID is not found.
