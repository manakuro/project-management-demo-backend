...
type TeammateWhereInput struct {
	...
	// "teammate_tab_statuses" edge predicates.
	HasTeammateTabStatuses     *bool                          `json:"hasTeammateTabStatuses,omitempty"`
	HasTeammateTabStatusesWith []*TeammateTabStatusWhereInput `json:"hasTeammateTabStatusesWith,omitempty"`
...
func (i *TeammateWhereInput) P() (predicate.Teammate, error) {
	...
	if i.HasTeammateTabStatuses != nil {
		p := teammate.HasTeammateTabStatuses()
		if !*i.HasTeammateTabStatuses {
			p = teammate.Not(p)
		}
		predicates = append(predicates, p)
	}
	if len(i.HasTeammateTabStatusesWith) > 0 {
		with := make([]predicate.TeammateTabStatus, 0, len(i.HasTeammateTabStatusesWith))
		for _, w := range i.HasTeammateTabStatusesWith {
			p, err := w.P()
			if err != nil {
				return nil, err
			}
		...
		predicates = append(predicates, teammate.HasTeammateTabStatusesWith(with...))
	}
	if i.HasTeammateTaskColumns != nil {
...
// TeammateTabStatusWhereInput represents a where input for filtering TeammateTabStatus queries.
type TeammateTabStatusWhereInput struct {
	Not *TeammateTabStatusWhereInput   `json:"not,omitempty"`
	Or  []*TeammateTabStatusWhereInput `json:"or,omitempty"`
	And []*TeammateTabStatusWhereInput `json:"and,omitempty"`
...
// Filter applies the TeammateTabStatusWhereInput filter on the TeammateTabStatusQuery builder.
func (i *TeammateTabStatusWhereInput) Filter(q *TeammateTabStatusQuery) (*TeammateTabStatusQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
...
// P returns a predicate for filtering teammatetabstatusslice.
// An error is returned if the input is empty or invalid.
func (i *TeammateTabStatusWhereInput) P() (predicate.TeammateTabStatus, error) {
	var predicates []predicate.TeammateTabStatus
	if i.Not != nil {
		p, err := i.Not.P()
		if err != nil {
			return nil, err
		}
		predicates = append(predicates, teammatetabstatus.Not(p))
	}
	switch n := len(i.Or); {
	case n == 1:
		p, err := i.Or[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		or := make([]predicate.TeammateTabStatus, 0, n)
		for _, w := range i.Or {
			p, err := w.P()
			if err != nil {
				return nil, err
		...
		predicates = append(predicates, teammatetabstatus.Or(or...))
	}
	switch n := len(i.And); {
	case n == 1:
		p, err := i.And[0].P()
		...
		predicates = append(predicates, p)
	case n > 1:
		and := make([]predicate.TeammateTabStatus, 0, n)
		for _, w := range i.And {
			p, err := w.P()
			if err != nil {
				return nil, err
		...
		predicates = append(predicates, teammatetabstatus.And(and...))
	}
	if i.ID != nil {
		predicates = append(predicates, teammatetabstatus.IDEQ(*i.ID))
	}
	if i.IDNEQ != nil {
		predicates = append(predicates, teammatetabstatus.IDNEQ(*i.IDNEQ))
	}
	if len(i.IDIn) > 0 {
		predicates = append(predicates, teammatetabstatus.IDIn(i.IDIn...))
	}
	if len(i.IDNotIn) > 0 {
		predicates = append(predicates, teammatetabstatus.IDNotIn(i.IDNotIn...))
	}
	if i.IDGT != nil {
		predicates = append(predicates, teammatetabstatus.IDGT(*i.IDGT))
	}
	if i.IDGTE != nil {
		predicates = append(predicates, teammatetabstatus.IDGTE(*i.IDGTE))
	}
	if i.IDLT != nil {
		predicates = append(predicates, teammatetabstatus.IDLT(*i.IDLT))
	}
	if i.IDLTE != nil {
		predicates = append(predicates, teammatetabstatus.IDLTE(*i.IDLTE))
	}
	if i.WorkspaceID != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDEQ(*i.WorkspaceID))
	}
	if i.WorkspaceIDNEQ != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDNEQ(*i.WorkspaceIDNEQ))
	}
	if len(i.WorkspaceIDIn) > 0 {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDIn(i.WorkspaceIDIn...))
	}
	if len(i.WorkspaceIDNotIn) > 0 {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDNotIn(i.WorkspaceIDNotIn...))
	}
	if i.WorkspaceIDGT != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDGT(*i.WorkspaceIDGT))
	}
	if i.WorkspaceIDGTE != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDGTE(*i.WorkspaceIDGTE))
	}
	if i.WorkspaceIDLT != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDLT(*i.WorkspaceIDLT))
	}
	if i.WorkspaceIDLTE != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDLTE(*i.WorkspaceIDLTE))
	}
	if i.WorkspaceIDContains != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDContains(*i.WorkspaceIDContains))
	}
	if i.WorkspaceIDHasPrefix != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDHasPrefix(*i.WorkspaceIDHasPrefix))
	}
	if i.WorkspaceIDHasSuffix != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDHasSuffix(*i.WorkspaceIDHasSuffix))
	}
	if i.WorkspaceIDEqualFold != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDEqualFold(*i.WorkspaceIDEqualFold))
	}
	if i.WorkspaceIDContainsFold != nil {
		predicates = append(predicates, teammatetabstatus.WorkspaceIDContainsFold(*i.WorkspaceIDContainsFold))
	}
	if i.TeammateID != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDEQ(*i.TeammateID))
	}
	if i.TeammateIDNEQ != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDNEQ(*i.TeammateIDNEQ))
	}
	if len(i.TeammateIDIn) > 0 {
		predicates = append(predicates, teammatetabstatus.TeammateIDIn(i.TeammateIDIn...))
	}
	if len(i.TeammateIDNotIn) > 0 {
		predicates = append(predicates, teammatetabstatus.TeammateIDNotIn(i.TeammateIDNotIn...))
	}
	if i.TeammateIDGT != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDGT(*i.TeammateIDGT))
	}
	if i.TeammateIDGTE != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDGTE(*i.TeammateIDGTE))
	}
	if i.TeammateIDLT != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDLT(*i.TeammateIDLT))
	}
	if i.TeammateIDLTE != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDLTE(*i.TeammateIDLTE))
	}
	if i.TeammateIDContains != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDContains(*i.TeammateIDContains))
	}
	if i.TeammateIDHasPrefix != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDHasPrefix(*i.TeammateIDHasPrefix))
	}
	if i.TeammateIDHasSuffix != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDHasSuffix(*i.TeammateIDHasSuffix))
	}
	if i.TeammateIDEqualFold != nil {
		predicates = append(predicates, teammatetabstatus.TeammateIDEqualFold(*i.TeammateIDEqualFold))
	}
	if i.TeammateIDContainsFold != nil {
	...
	if i.CreatedAtNEQ != nil {
		predicates = append(predicates, teammatetabstatus.CreatedAtNEQ(*i.CreatedAtNEQ))
	}
	if len(i.CreatedAtIn) > 0 {
		predicates = append(predicates, teammatetabstatus.CreatedAtIn(i.CreatedAtIn...))
	}
	if len(i.CreatedAtNotIn) > 0 {
		predicates = append(predicates, teammatetabstatus.CreatedAtNotIn(i.CreatedAtNotIn...))
	}
	if i.CreatedAtGT != nil {
		predicates = append(predicates, teammatetabstatus.CreatedAtGT(*i.CreatedAtGT))
	}
	if i.CreatedAtGTE != nil {
		predicates = append(predicates, teammatetabstatus.CreatedAtGTE(*i.CreatedAtGTE))
	}
	if i.CreatedAtLT != nil {
		predicates = append(predicates, teammatetabstatus.CreatedAtLT(*i.CreatedAtLT))
	}
	if i.CreatedAtLTE != nil {
		predicates = append(predicates, teammatetabstatus.CreatedAtLTE(*i.CreatedAtLTE))
	}
	if i.UpdatedAt != nil {
		predicates = append(predicates, teammatetabstatus.UpdatedAtEQ(*i.UpdatedAt))
	}
	if i.UpdatedAtNEQ != nil {
		predicates = append(predicates, teammatetabstatus.UpdatedAtNEQ(*i.UpdatedAtNEQ))
	}
	if len(i.UpdatedAtIn) > 0 {
		predicates = append(predicates, teammatetabstatus.UpdatedAtIn(i.UpdatedAtIn...))
	}
	if len(i.UpdatedAtNotIn) > 0 {
		predicates = append(predicates, teammatetabstatus.UpdatedAtNotIn(i.UpdatedAtNotIn...))
	}
	if i.UpdatedAtGT != nil {
		predicates = append(predicates, teammatetabstatus.UpdatedAtGT(*i.UpdatedAtGT))
	}
	if i.UpdatedAtGTE != nil {
		predicates = append(predicates, teammatetabstatus.UpdatedAtGTE(*i.UpdatedAtGTE))
	}
	if i.UpdatedAtLT != nil {
		predicates = append(predicates, teammatetabstatus.UpdatedAtLT(*i.UpdatedAtLT))
	}
	if i.UpdatedAtLTE != nil {
		predicates = append(predicates, teammatetabstatus.UpdatedAtLTE(*i.UpdatedAtLTE))
	}

	if i.HasWorkspace != nil {
		p := teammatetabstatus.HasWorkspace()
		if !*i.HasWorkspace {
			p = teammatetabstatus.Not(p)
		}
		predicates = append(predicates, p)
	}
	if len(i.HasWorkspaceWith) > 0 {
		...
		predicates = append(predicates, teammatetabstatus.HasWorkspaceWith(with...))
	}
	if i.HasTeammate != nil {
		p := teammatetabstatus.HasTeammate()
		if !*i.HasTeammate {
			p = teammatetabstatus.Not(p)
		}
		predicates = append(predicates, p)
	...
	if len(i.HasTeammateWith) > 0 {
		...
		predicates = append(predicates, teammatetabstatus.HasTeammateWith(with...))
	}
	switch len(predicates) {
	case 0:
		return nil, fmt.Errorf("project-management-demo-backend/ent: empty predicate TeammateTabStatusWhereInput")
	case 1:
		return predicates[0], nil
	default:
		return teammatetabstatus.And(predicates...), nil
	}
}
...
func (i *WorkspaceWhereInput) P() (predicate.Workspace, error) {
	...
	if i.HasTeammateTabStatuses != nil {
		p := workspace.HasTeammateTabStatuses()
		if !*i.HasTeammateTabStatuses {
			p = workspace.Not(p)
		}
		predicates = append(predicates, p)
	...
	if len(i.HasTeammateTabStatusesWith) > 0 {
		...
		predicates = append(predicates, workspace.HasTeammateTabStatusesWith(with...))
	}
	switch len(predicates) {
	case 0:
