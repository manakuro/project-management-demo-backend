...
const (
	// Label holds the string label denoting the teammatetabstatus type in the database.
	Label = "teammate_tab_status"
	...
	// Table holds the table name of the teammatetabstatus in the database.
	Table = "teammate_tab_status"
	// WorkspaceTable is the table that holds the workspace relation/edge.
	WorkspaceTable = "teammate_tab_status"
	...
	TeammateTable = "teammate_tab_status"
...
// Columns holds all SQL columns for teammatetabstatus fields.
var Columns = []string{
	FieldID,
	FieldWorkspaceID,
	FieldTeammateID,
