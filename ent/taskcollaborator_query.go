...
// Returns a *NotSingularError when exactly one TaskCollaborator entity is not found.
...
// Returns a *NotSingularError when exactly one TaskCollaborator ID is not found.
