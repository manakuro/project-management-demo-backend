...
func AgeEQ(v int) predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldAge), v))
	})
}
...
func AgeNEQ(v int) predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
...
func AgeIn(vs ...int) predicate.Test {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func AgeNotIn(vs ...int) predicate.Test {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func AgeGT(v int) predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
...
func AgeGTE(v int) predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
...
func AgeLT(v int) predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
...
func AgeLTE(v int) predicate.Test {
	return predicate.Test(func(s *sql.Selector) {
